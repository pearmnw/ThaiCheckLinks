      ...
      <div className="flex justify-center mb-3">
        ...
        <div className= "pl-6">
            <span className="flex items-center justify-center">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M2 10C2 5.58172 5.58172 2 10 2C14.4183 2 18 5.58172 18 10C18 14.4183 14.4183 18 10 18C5.58172 18 2 14.4183 2 10ZM4 12.5C4 12.5 10 20.5 15.5 10C15.5 6.96243 13 4 10 4.5L7 8.5L4 12.5Z" fill="white"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.7072 14.293L21.7072 20.293L20.293 21.7072L14.293 15.7072L15.7072 14.293Z" fill="white"/>
                <path d="M16.5 10C16.5 13.866 13.866 16.5 10 16.5C6.13401 16.5 3.5 13.866 3.5 10C3.5 6.13401 6.5 3.5 10 3.5C13.866 3.5 16.5 6.13401 16.5 10Z" fill="#121B2B"/>
                </svg>
              </span>
          </div>
