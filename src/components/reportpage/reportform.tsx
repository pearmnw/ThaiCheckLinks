...
const ReportForm = ({
  ...
  // Function to check the report information and display the caution message
  ...
  const onSubmit = async () => {
    try {
      ...
      // sends a POST request to api/linkreport
      ...
      console.log(data);
      // if res ok and report collected in the database
              ...
              <div className="flex py-8">
                ...
                <div className="px-[1rem]">
                  <textarea
                    ...
                    // TODO: Let receive the paste text
                    onPaste={(event) => {
                      event.preventDefault();
