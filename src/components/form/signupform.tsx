                  ...
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 space-y-4">
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        By accessing and placing an order with ThaiScamLinks,
                        you confirm that you are in agreement with and bound by
                        ...
                        <br></br>
                        <br></br>
                        Under no circumstances shall the ThaiScamLinks team be
                        liable for any direct, indirect, special, incidental, or
                        consequential damages, including, but not limited to,
                        loss of data or profit, arising out of the use, or the
                        inability to use, the materials on this site, even if
                        ThaiScamLinks team or an authorized representative has
                        been advised of the possibility of such damages. If your
                        use of materials from this site results in the need for
                        servicing, repair, or correction of equipment or data,
                        you assume any costs thereof.
                        <br></br>
                        <br></br>
                        ThaiScamLinks will not be responsible for any outcome
                        that may occur during the usage of our resources. We
                        reserve the right to change prices and revise the
                        resource usage policy at any moment.
                      </p>
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 text-[20px]">
                        License
                      </p>
                      ...
                      <p className="indent-5 list-disc text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        <li>
                          Cookie: a small amount of data generated by a website
                        ...
                        <li>
                          Country: where ThaiScamLinks or the owners/founders of
                          ThaiScamLinks are based, in this case, Thailand.
                        </li>
                        <li>
                          Customer: refers to the company, organization, or
                          person that signs up to use the ThaiScamLinks Service
                        ...
                        <li>
                          ...
                          to visit ThaiScamLinks and use the services.
                        </li>
                        <li>
                      ...
                      <p className="indent-5 list-disc text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        <li>
                          ...
                          decrypt, reverse compile, or reverse engineer any part
                          of the service.
                        </li>
                        <li>
                          Modify, make derivative works of, disassemble,
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        temporarily or permanently, the service or any service
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        You acknowledge and agree that we may stop (permanently
                        or temporarily) providing the Service (or any features
                        within the Service) to you or to users generally at our
                        sole discretion, without prior notice to you. You may
                        stop using the Service at any time. You do not need to
                        specifically inform us when you stop using the Service.
                        You acknowledge and agree that if we disable access to
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        entire liability of us and any of our suppliers under
                        any provision of this Agreement and your exclusive
                        remedy for all of the foregoing shall be limited to the
                        amount actually paid by you for the service. To the
                        maximum extent permitted by applicable law, in no event
                        shall we or our suppliers be liable for any special,
                        incidental, indirect, or consequential damages
                        whatsoever (including, but not limited to, damages for
                        loss of profits, for loss of data or other information,
                        for business interruption, for personal injury, for loss
                        of privacy arising out of or in any way related to the
                        ...
                        of this Agreement), even if we or any supplier has been
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        shall constitute the entire agreement between you and us
                        concerning the Services. If any provision of this
                        ...
                        under this Agreement shall not constitute a waiver of
                        such right or provision. YOU AND US AGREE THAT ANY CAUSE
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 text-[20px]">
                        ...
                        the part of either party, any right or any power under
                        this Agreement shall operate as a waiver of that right
                        or power. Nor shall any single or partial exercise of
                        any right or power under this Agreement preclude further
                        exercise of that or any other right granted herein. In
                        the event of a conflict between this Agreement and any
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        you and us regarding your use of the service and
                        supersedes all prior and contemporaneous written or oral
                        agreements between you and us. You may be subject to
                        additional terms and conditions that apply when you use
                        or purchase other services from us, which we will
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        to make changes to these Terms so that they accurately
                        reflect our Service and policies. Unless otherwise
                        required by law, we will notify you (for example,
                        through our Service) before we make change to these
                        Terms and give you an opportunity to review them before
                        they go into effect. Then, if you continue to use the
                        Service, you will be bound by the updated Terms. If you
                        do not want to agree to these or any updated Terms, you
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        providers of such material and are protected by Thailand
                        ...
                        permission of us, unless and except as is expressly
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        sole property of us without any compensation or credit
                        to you whatsoever. We and our affiliates shall have no
                        obligations concerning such submissions or posts and may
                        use the ideas contained in such submissions or posts for
                        any purposes in any medium in perpetuity, including, but
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        sweepstakes, or other activities (“Promotions”) that
                        require you to submit material or information concerning
                        yourself. Please note that all Promotions may be
                        governed by separate rules that may contain certain
                        eligibility requirements, such as restrictions as to age
                        and geographic location. You are responsible to read all
                        Promotions rules to determine whether or not you are
                        eligible to participate. If you enter any Promotion, you
                        agree to abide by and comply with all Promotions Rules.
                        Additional terms and conditions may apply to purchases
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        Conditions to be unenforceable, the remainder of these
                        Terms & Conditions will continue in full force and
                        effect. Any waiver of any provision of these Terms &
                        Conditions will be effective only if in writing and
                        signed by an authorized representative of us. We will be
                        entitled to injunctive or other equitable relief
                        (without the obligations of posting any bond or surety)
                        in the event of any breach or anticipatory breach by
                        you. We operate and control our Service from our offices
                        in Thailand. The Service is not intended for
                        distribution to or use by any person or entity in any
                        jurisdiction or country where such distribution or use
                        would be contrary to law or regulation. Accordingly,
                        those persons who choose to access our Service from
                        other locations do so on their own initiative and are
                        solely responsible for compliance with local laws, if
                        and to the extent local laws are applicable. These Terms
                        & Conditions (which include and incorporate our Privacy
                        Policy) contains the entire understanding and supersedes
                        all prior understandings, between you and us concerning
                        its subject matter, and cannot be changed or modified by
                        you. The section headings used in this Agreement are for
                      ...
                      <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        of contract, negligence, or other tort, arising out of
                        or in connection with the use of the Service or the
                        contents of the Service. We reserve the right to make
                  ...
                  <div className="p-4 md:p-5 space-y-4">
                    ...
                    <p className="indent-5 list-disc text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      ...
                      <li>
                        ...
                        that signs up to use the ThaiScamLinks Service to manage
                      ...
                      <li>
                        ...
                        address. These numbers are usually assigned in
                        geographic blocks. An IP address can often be used to
                        identify the location from which a device is connecting
                        to the Internet.
                      </li>
                      <li>
                        Personnel: refers to those individuals who are employed
                        by ThaiScamLinks or are under contract to perform a
                        service on behalf of one of the parties.
                      </li>
                      <li>
                        Personal Data: any information that directly,
                        indirectly, or in connection with other information —
                        including a personal identification number — allows for
                        the identification or identifiability of a natural
                        person.
                      </li>
                      <li>
                        Service: refers to the service provided by ThaiScamLinks
                      ...
                      <li>
                        Website: ThaiScamLinks’s site, which can be accessed via
                        this URL: www.ThaiScamLinks.com.
                      </li>
                      <li>
                        You: a person or entity that is registered with
                        ThaiScamLinks to use the Services.
                    ...
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      We are incorporated in Thailand. Information collected via
                      our website, through direct interactions with you, or from
                      the use of our help services may be transferred from time
                      to time to our offices or personnel, or to third parties,
                      located throughout the world, and may be viewed and hosted
                      anywhere in the world, including countries that may not
                    ...
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      By using our service, registering an account, you consent
                    ...
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      ...
                      age of 13 without verification of parental consent, We
                    ...
                    <p className="indent-5 text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      ...
                      functionality like videos may become unavailable or you
                      would be required to enter your login details every time
                      you visit our service as we would not be able to remember
                    ...
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 text-[20px]">
                      Information about the Personal Data Protection Act (PDPA)
                      of Thailand
                    </p>
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      We may be collecting and using information from you if you
                      are in Thailand, and in this section of our Privacy
                      Policy, we are going to explain exactly how and why this
                      data is collected, and how we maintain this data under
                    ...
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      ...
                      information relating to an identifiable individual. PDPA
                      covers a broad spectrum of information that could be used,
                      either alone or in combination with other pieces of
                      information, to identify a person. Examples include but
                      are not limited to, name, contact details, financial
                      information, biometric data, IP addresses, and more.
                      <br></br>
                      <br></br>
                      The Data Protection Principles outlined in PDPA include
                    ...
                    <p className="indent-5 text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      ...
                      Individuals covered by PDPA have the right to access their
                    ...
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      ...
                      subject rights requirements of PDPA. ThaiScamLinks.com
                      processes or stores all personal data in fully vetted,
                      PDPA-compliant vendors. We retain all conversation and
                      personal data for up to 2024, unless your account is
                      deleted. In such cases, we dispose of all data in
                      accordance with our Terms of Service and Privacy Policy,
                      but we will not hold it for longer than 2025.
                      <br></br>
                      <br></br>
