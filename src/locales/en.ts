export default {
  ...
  homepage: {
    ...
    caption:
      'Enter your link in the verification box to check your website and stage percentage of scammers against the criminal history database.',
  ...
  report: {
    ...
    caption:
      'Sign in or sign up before reporting information to ensure accuracy.',
    signin: 'Sign In',
    signup: 'Sign Up',
    caption2:
      'Reporting unlawful links here can help investigators find criminal websites',
    placeholder: 'Enter link eg. https://www.example.com ...',
    searchbutt: 'Confirm',
    ...
    moredetailError2:
      'Please ensure your input contains between 10 and 500 characters.',
  ...
  reportsuccess: {
    ...
    'sub-title2':
      'We will continue to use criminal web investigations to help the public.',
  ...
  verificationpage: {
    ...
    'overall-subtitle':
      'The Percentage Of Risk Of Being An suspicious Website Is Based On All Citeria',
    ...
    'found-thai-scam-link':
      'Found In History Website Reported in Thai.CheckLinks',
    ...
    'report-subtitle':
      'Verify Against The User Reporting Database In Thai.ScamLinks',
